...
export default function BlogPageAr() {
  ...
  const featured = getFeaturedPostsAr();
  const gridPosts = getGridPostsAr();
  ...
  return (
    <>
      ...
      <PageHero eyebrow="مدونتنا" title="رؤى لرحلتك" />
      ...
      >
        ...
        >
          ...
          >
            احصل على رؤى الصحة النفسية في بريدك الإلكتروني
          </h3>
          <div
