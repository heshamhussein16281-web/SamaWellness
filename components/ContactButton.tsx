  ...
  return (
    <>
      ...
      >
        ...
        <div className="contact-btn-text">CONTACT<br/>US</div>
      </button>
      ...
      {isOpen && (
        <div className="contact-modal-overlay" onClick={() => setIsOpen(false)}>
          <div className="contact-modal" onClick={(e) => e.stopPropagation()}>
            ...
            {/* Modal Header */}
            <h2 className="contact-modal-heading">Get In Touch</h2>
            ...
            <div className="contact-modal-items">
              {/* Email */}
              <a
                href="mailto:info@samawellnesstherapy.com"
