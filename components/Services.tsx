  ...
  },
  {
    ...
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
        ...
        <path d="M2 44c0-7.732 6.268-14 14-14s14 6.268 14 14" stroke="#7b2d3e" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
        <path d="M32 30c7.732 0 14 6.268 14 14" stroke="#7b2d3e" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
      </svg>
    ),
  },
  {
...
export default function Services() {
  return (
    <section id="services" className="bg-linen py-24">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {services.map((s, i) => (
            <div key={i} className="flex flex-col items-center text-center">
              ...
              <h3 className="font-nav text-xs tracking-[0.2em] uppercase text-charcoal font-semibold mb-4">
                {s.title}
              </h3>
