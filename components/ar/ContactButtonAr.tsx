...
export default function ContactButtonAr() {
  ...
  return (
    <>
      <button
        ...
        title="تواصل معنا"
      >
        <div className="contact-btn-icon">💬</div>
        <div className="contact-btn-text">تواصل<br />معنا</div>
      </button>
      ...
      {isOpen && (
        <div className="contact-modal-overlay" onClick={() => setIsOpen(false)}>
          <div className="contact-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className="contact-modal-heading">تواصل معنا</h2>
            <p className="contact-modal-subtext">تقدر توصلنا من خلال أي من القنوات دي</p>

            <div className="contact-modal-items">
              <a href="mailto:info@samawellnesstherapy.com" className="contact-modal-item">
                <div className="contact-modal-icon">✉</div>
                <div className="contact-modal-content">
                  <h3>البريد الإلكتروني</h3>
                  <p>info@samawellnesstherapy.com</p>
                </div>
              </a>

              <a href="tel:+201130946556" className="contact-modal-item">
                <div className="contact-modal-icon">📞</div>
                <div className="contact-modal-content">
                  <h3>الهاتف</h3>
                  <p dir="ltr">(+2) 01130946556</p>
                </div>
              </a>
