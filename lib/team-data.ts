...
export const therapists: Therapist[] = [
  ...
  },
  {
    id: 7,
    name: "Samar Samy",
    title: "Relationship and Psychosexual Psychotherapist",
    approach: "Integrative person-centered approach tailored to individual and couple's unique needs, with expertise in relational, sexual, and emotional concerns.",
  ...
  },
  {
    ...
    title: "Clinical Psychologist",
    approach: "Eclectic approach drawing primarily on schema therapy and EMDR, alongside dialectical behavior therapy (DBT), addressing behavioral, cognitive, and emotional dimensions to strengthen self-esteem and resolve childhood trauma.",
    image: "/team/nancy.jpg",
    bio: "Nancy is a Clinical Psychologist who earned both her undergraduate degree in Clinical Psychology and her Master's degree at Nice Sophia-Antipolis University in France. She believes that personality disorders, anxiety disorders, stress-related disorders, low self-esteem, and low self-confidence often result from experiencing childhood trauma — such as sexual and physical abuse, war, and accidents — as well as compromised attachment between the child and their caregivers.\n\nDuring her clinical practice, Nancy has worked in several clinical facilities across France, Tunisia, and Egypt. She has worked with a large number of survivors of torture, sexual and physical violence, as well as individuals with personality disorders, mood disorders, and anxiety disorders. She also developed a stress reduction curriculum for paramedical and medical staff at a dementia nursing facility (Les IRIS) and the emergency department at Pasteur 2 Hospital in Nice, France. Additionally, she worked with the Association des Femmes Démocrates in Tunisia, supporting the psychological rehabilitation of women victims of violence.\n\nHer therapeutic approach is eclectic, drawing primarily on schema therapy and EMDR, alongside selected techniques from dialectical behavior therapy (DBT). She works across multiple dimensions — behavioral change, cognitive restructuring, and emotional processing — while placing emphasis on strengthening clients' self-esteem and resolving childhood trauma. By the time clients complete therapy, they leave equipped with a robust set of skills and the resilience to navigate future challenges independently.",
    specializations: ["Schema Therapy", "EMDR", "Childhood Trauma", "Personality Disorders", "Anxiety Disorders", "Stress-Related Disorders", "Low Self-Esteem", "Survivors of Violence"],
  },
];
